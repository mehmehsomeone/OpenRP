...
#define ADMIN_TELEPORT				4 // /qwtele command
#define ADMIN_KILL					8 // /qwkill command
#define ADMIN_SLEEP					16 // /qwsleep command
#define ADMIN_MUTE					32 // /qwmute command
...
#define PLAYER_ACCLOGGEDOUT			1 //This player is currently not logged in to an account.
#define PLAYER_ACCLOGGEDIN			2 //This player is currently logged in to an account.

//Duel stuff
#define SABER_DUEL					1
#define MELEE_DUEL					2
#define FORCE_DUEL					3
#define FORCE_ONLY_DUEL				4
#define WEAPONS_DUEL				5
...
typedef struct {
	...
	char IP[16];					//The players IP Address is stored here. Used for banning.
	int DuelType;					//Don't want to put it here but it stores what your duel type is
	qboolean Scaled;				//has the player re-scaled themselves?
...
extern vmCvar_t		openrp_admin4Pass;
extern vmCvar_t		openrp_admin5Pass;
extern vmCvar_t		openrp_admin6Pass;
extern vmCvar_t		openrp_admin7Pass;
