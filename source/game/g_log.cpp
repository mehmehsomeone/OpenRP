...
{
	WP_NONE,				//MOD_UNKNOWN,
	WP_TUSKEN_RIFLE,		//MOD_STUN_BATON, FIXMETODO
	WP_MELEE,				//MOD_MELEE,
	WP_SABER,				//MOD_SABER,
	...
	WP_GRENADE,			//MOD_TRIP_MINE_SPLASH,
	WP_GRENADE,			//MOD_TIMED_MINE_SPLASH,
...
qboolean CalculateTactician(gentity_t *ent, int *kills)
{
	...
	for (person=0; person<g_maxclients.integer; person++)
	{
		...
		weapon=WP_MELEE;		// Start At Melee
...
void CalculateAwards(gentity_t *ent, char *msg)
{
	...
	int			awardFlags = 0, efficiency = 0, stuffUsed = 0, kills = 0, teamAwards = 0;
...
{
	int i = 0, nMostKills = 0, fav=0, weapon=WP_MELEE;
	int	killsWithWeapon[WP_NUM_WEAPONS];
	...
	//----------------------------------------------------------------
	nMostKills=0;
	for (weapon=WP_TUSKEN_RIFLE; weapon<WP_NUM_WEAPONS; weapon++)
	{
