...
*/
	...
	vehicle->VehicleMovementModesActive = qfalse;

	vehicle->MBFstopprimaryfiring = 0;					
	vehicle->MBFstopaltfiring = 0;
	vehicle->MBFdisableshields = 0;

	vehicle->CantKnockoutShields = qfalse;
	vehicle->AllWeaponsDoDamageToArmor = qfalse;
	vehicle->AllWeaponsDoDamageToShields = qfalse;
	vehicle->ResistsMarking = qfalse;
