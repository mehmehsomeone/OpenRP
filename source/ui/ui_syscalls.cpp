...
{
	return (qboolean)syscall(UI_G2_SETSKIN, ghoul2, modelIndex, customSkin, renderSkin);
}
...
{
	return (qboolean)syscall(UI_G2_PLAYANIM, ghoul2, modelIndex, boneName, startFrame, endFrame, flags, PASSFLOAT(animSpeed), currentTime, PASSFLOAT(setFrame), blendTime);
}
...
{
	return (qboolean)syscall(UI_G2_GETBONEANIM, ghoul2, boneName, currentTime, currentFrame, startFrame, endFrame, flags, animSpeed, modelList, modelIndex);
}
...
{
	return (qboolean)syscall(UI_G2_GETBONEFRAME, ghoul2, boneName, currentTime, currentFrame, modelList, modelIndex);
}
...
{
	return (qboolean)syscall(UI_G2_HASGHOUL2MODELONINDEX, ghlInfo, modelIndex);
}

qboolean trap_G2API_RemoveGhoul2Model(void *ghlInfo, int modelIndex)
{
	return (qboolean)syscall(UI_G2_REMOVEGHOUL2MODEL, ghlInfo, modelIndex);
}
...
{
	return (qboolean)syscall(UI_G2_SETROOTSURFACE, ghoul2, modelIndex, surfaceName);
}

qboolean trap_G2API_SetSurfaceOnOff(void *ghoul2, const char *surfaceName, const int flags)
{
	return (qboolean)syscall(UI_G2_SETSURFACEONOFF, ghoul2, surfaceName, flags);
}

qboolean trap_G2API_SetNewOrigin(void *ghoul2, const int boltIndex)
{
	return (qboolean)syscall(UI_G2_SETNEWORIGIN, ghoul2, boltIndex);
}
...
{
	return (qboolean)syscall(UI_G2_SETBONEIKSTATE, ghoul2, time, boneName, ikState, params);
}

qboolean trap_G2API_IKMove(void *ghoul2, int time, sharedIKMoveParams_t *params)
{
	return (qboolean)syscall(UI_G2_IKMOVE, ghoul2, time, params);
}
...
{
	return (qboolean)syscall(UI_G2_ATTACHG2MODEL, ghoul2From, modelIndexFrom, ghoul2To, toBoltIndex, toModel);
}
/*
Ghoul2 Insert End
*/
